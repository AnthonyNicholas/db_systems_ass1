...
import java.io.*;
    ...
    public class Record{
        ...
        byte [] b_name, b_status, b_reg_dt, b_canc_dt, b_renew_dt, b_state_num, b_state, b_abn, field_delimiter, record_delimiter; 
        int byteLength;
        ...
        public Record(String[] args){
            ...
            this.record_delimiter = "|".getBytes();         
            this.field_delimiter = "#".getBytes();         
